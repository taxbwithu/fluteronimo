...
class _$_GameInfo implements _GameInfo {
  ...
  @override
  String toString() {
    return 'GameInfo(storeID: $storeID, gameID: $gameID, name: $name, steamAppID: $steamAppID, salePrice: $salePrice, retailPrice: $retailPrice, steamRatingText: $steamRatingText, steamRatingPercent: $steamRatingPercent, metacriticScore: $metacriticScore, releaseDate: $releaseDate, publisher: $publisher, thumb: $thumb)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.steamRatingText, steamRatingText) ||
                other.steamRatingText == steamRatingText) &&
            (identical(other.steamRatingPercent, steamRatingPercent) ||
